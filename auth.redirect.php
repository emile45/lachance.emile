...
if (!isset($_POST['nom'],$_POST['mdp'])){
    ...
    setcookie("erreurAuth", "Refus de traitement.", 0, "/", "lachance.techinfo420.ca", true, true);
    ...
    setcookie("erreurAuth", "Il manque des informations pour l'authentification", 0, "/", "lachance.techinfo420.ca", true, true);
    header("Location: index.php");
    ...
    if (Authentifier::getAuthentification($nom,$mdp)){
         ...
         */
        setcookie("erreurAuth", "Votre identifiant n'est pas valide", 0, "/", "lachance.techinfo420.ca", true, true);
        header("Location: index.php");
        //echo "Interdit";
    }
}
